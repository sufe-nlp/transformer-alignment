...
def validate(args, trainer, task, epoch_itr, subsets):
    ...
    for subset in subsets:
        ...
        # print(args.max_tokens_valid, args.max_sentences_valid, utils.resolve_max_positions(task.max_positions(), trainer.get_model().max_positions()))
        # print(args.skip_invalid_size_inputs_valid_test,args.required_batch_size_multiple,)
        progress = progress_bar.build_progress_bar(
